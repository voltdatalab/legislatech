...
def processar_projeto(projeto, limite=15, past_days=7):
    try:
        ...
        email_obj = _email(
            ...
            notification_intro="Esse email foi produzido e disparado automaticamente a partir da customização que você fez no Legislatech.  Aqui, reunimos uma amostra de até 15 itens por órgão monitorado. Para ver a relação completa de termos que você está monitorando, acesse o painel em <a href='https://nucle.ooo/auto-report-legislatech'>nucleo.jor.br/legislatech</a>.",
